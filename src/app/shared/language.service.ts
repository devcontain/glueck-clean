...
export class LanguageService {
  ...
  public legalNoticeDe = {
    ...
    s2A3: 'Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden. Sofern über die Website Verträge geschlossen oder angebahnt werden können, werden die übermittelten Daten auch für Vertragsangebote, Bestellungen oder sonstige Auftragsanfragen verarbeitet.',
    ...
    s2A4b: 'Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit an uns wenden.',

    s3Title: '2. Hosting',
    s3P1: 'Wir hosten die Inhalte unserer Website bei folgendem Anbieter:',
    s3ProviderTitle: 'Strato',
    s3ProviderText: 'Anbieter ist die Strato AG, Otto-Ostrowski-Straße 7, 10249 Berlin (nachfolgend „Strato“). Wenn Sie unsere Website besuchen, erfasst Strato verschiedene Logfiles inklusive Ihrer IP-Adressen.',
    s3InfoText: 'Weitere Informationen entnehmen Sie der Datenschutzerklärung von Strato:',
    s3ProviderUrl: 'https://www.strato.de/datenschutz/',
    s3LegalBasis: 'Die Verwendung von Strato erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Wir haben ein berechtigtes Interesse an einer möglichst zuverlässigen Darstellung unserer Website. Sofern eine entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung ausschließlich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von Cookies oder den Zugriff auf Informationen im Endgerät des Nutzers (z. B. Device-Fingerprinting) im Sinne des TDDDG umfasst. Die Einwilligung ist jederzeit widerrufbar.',
    s3ProcessingTitle: 'Auftragsverarbeitung',
    s3ProcessingText: 'Wir haben einen Vertrag über Auftragsverarbeitung (AVV) zur Nutzung des oben genannten Dienstes geschlossen. Hierbei handelt es sich um einen datenschutzrechtlich vorgeschriebenen Vertrag, der gewährleistet, dass dieser die personenbezogenen Daten unserer Websitebesucher nur nach unseren Weisungen und unter Einhaltung der DSGVO verarbeitet.',

    s4Title: '3. Allgemeine Hinweise und Pflichtinformationen',
    ...
    s5Intro: 'Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:',
    s5Name: 'Katja Wersuhn',
    s5Street: 'Kramstr. 9',
    s5City: '29410 Salzwedel',
    s5Phone: 'Telefon: 0174 / 384 67 42',
    s5Email: 'E-Mail: jetzt@glück-selbermachen.de',
    ...
    s15Subtitle: 'SSL- bzw. TLS-Verschlüsselung',
    s15P1: 'Diese Seite nutzt aus Sicherheitsgründen und zum Schutz der Übertragung vertraulicher Inhalte, wie zum Beispiel Bestellungen oder Anfragen, die Sie an uns als Seitenbetreiber senden, eine SSL- bzw. TLS-Verschlüsselung. Eine verschlüsselte Verbindung erkennen Sie daran, dass die Adresszeile des Browsers von „http://“ auf „https://“ wechselt und an dem Schloss-Symbol in Ihrer Browserzeile.',
    s15P2: 'Wenn die SSL- bzw. TLS-Verschlüsselung aktiviert ist, können die Daten, die Sie an uns übermitteln, nicht von Dritten mitgelesen werden.',

    s16Subtitle: 'Widerspruch gegen Werbe-E-Mails',
    s16P: 'Der Nutzung von im Rahmen der Impressumspflicht veröffentlichten Kontaktdaten zur Übersendung von nicht ausdrücklich angeforderter Werbung und Informationsmaterialien wird hiermit widersprochen. Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch Spam-E-Mails, vor.',

    s17Title: '4. Datenerfassung auf dieser Website',
    s17Subtitle: 'Server-Log-Dateien',
    s17Intro: 'Der Provider der Seiten erhebt und speichert automatisch Informationen in so genannten Server-Log-Dateien, die Ihr Browser automatisch an uns übermittelt. Dies sind:',
    s17Li1: 'Browsertyp und Browserversion',
    s17Li2: 'verwendetes Betriebssystem',
    s17Li3: 'Referrer URL',
    s17Li4: 'Hostname des zugreifenden Rechners',
    s17Li5: 'Uhrzeit der Serveranfrage',
    s17Li6: 'IP-Adresse',
    s17P1: 'Eine Zusammenführung dieser Daten mit anderen Datenquellen wird nicht vorgenommen.',
    s17P2: 'Die Erfassung dieser Daten erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO. Der Websitebetreiber hat ein berechtigtes Interesse an der technisch fehlerfreien Darstellung und der Optimierung seiner Website - hierzu müssen die Server-Log-Files erfasst werden.',

    s18Subtitle: 'Anfrage per E-Mail, Telefon oder Telefax',
    s18P1: 'Wenn Sie uns per E-Mail, Telefon oder Telefax kontaktieren, wird Ihre Anfrage inklusive aller daraus hervorgehenden personenbezogenen Daten (Name, Anfrage) zum Zwecke der Bearbeitung Ihres Anliegens bei uns gespeichert und verarbeitet. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.',
    ...
    s18P3: 'Die von Ihnen an uns per Kontaktanfragen übersandten Daten verbleiben bei uns, bis Sie uns zur Löschung auffordern, Ihre Einwilligung zur Speicherung widerrufen oder der Zweck für die Datenspeicherung entfällt (z. B. nach abgeschlossener Bearbeitung Ihres Anliegens). Zwingende gesetzliche Bestimmungen - insbesondere gesetzliche Aufbewahrungsfristen - bleiben unberührt.',

    sourceLabel: 'Quelle:',
    sourceText: 'https://www.e-recht24.de',
    sourceUrl: 'https://www.e-recht24.de'
  };

  public imprintDe = {
    title: 'Impressum',
    addressName: 'Katja Wersuhn',
    businessName: 'Glueck-Selbermachen',
    addressStreet: 'Kramstr. 9',
    addressCity: '29410 Salzwedel',

    contactTitle: 'Kontakt',
    phoneLabel: 'Telefon:',
    phone: '0174 / 384 67 42',
    emailLabel: 'E-Mail:',
    emailText: 'jetzt@glück-selbermachen.de',
